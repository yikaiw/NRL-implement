...
def read_edges(train_filename, test_filename=None, mode=""):
    """read the data from trainging file and testing file

    Args:
        train_filename, test_filename
    Returns:
        user_num, item_num, linked_nodes
    """
    ...
    return user_num, len(item_nodes), linked_nodes
